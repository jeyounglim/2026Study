...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, getRequestURL, getResponseHeader, appendResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, getResponseStatusText } from 'file://C:/news-scraper/2026Study/node_modules/h3/dist/index.mjs';
import { escapeHtml } from 'file://C:/news-scraper/2026Study/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/news-scraper/2026Study/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file://C:/news-scraper/2026Study/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/news-scraper/2026Study/node_modules/vue/server-renderer/index.mjs';
import { klona } from 'file://C:/news-scraper/2026Study/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/news-scraper/2026Study/node_modules/defu/dist/defu.mjs';
import destr, { destr as destr$1 } from 'file://C:/news-scraper/2026Study/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file://C:/news-scraper/2026Study/node_modules/scule/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/news-scraper/2026Study/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/news-scraper/2026Study/node_modules/devalue/index.js';
import { isVNode, toValue, isRef } from 'file://C:/news-scraper/2026Study/node_modules/vue/index.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/news-scraper/2026Study/node_modules/unhead/dist/plugins.mjs';
import { createHooks } from 'file://C:/news-scraper/2026Study/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file://C:/news-scraper/2026Study/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file://C:/news-scraper/2026Study/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/news-scraper/2026Study/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/news-scraper/2026Study/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file://C:/news-scraper/2026Study/node_modules/ohash/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/news-scraper/2026Study/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file://C:/news-scraper/2026Study/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file://C:/news-scraper/2026Study/node_modules/youch-core/build/index.js';
import { Youch } from 'file://C:/news-scraper/2026Study/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file://C:/news-scraper/2026Study/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getContext } from 'file://C:/news-scraper/2026Study/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://C:/news-scraper/2026Study/node_modules/errx/dist/index.js';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file://C:/news-scraper/2026Study/node_modules/pathe/dist/index.mjs';
import { walkResolver } from 'file://C:/news-scraper/2026Study/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"C:/news-scraper/2026Study/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/news-scraper/2026Study","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:/news-scraper/2026Study/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/news-scraper/2026Study/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:/news-scraper/2026Study/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:/news-scraper/2026Study/.data/kv"}));
...
const _VKJHetv2tThvbYgUfWntkIWWvKq_Mw6V6Bnx1GiysmA = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/news-scraper/2026Study";

const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"뉴스 URL을 입력하면 관련 기사를 찾아드립니다"}],"link":[],"style":[],"script":[],"noscript":[],"title":"뉴스 스크래퍼"};
...
const _LLBkxL_DVxr8MB7QJOIrh7wRxslYMSy3UexKfXRZuFI = (nitroApp) => {
...
const plugins = [
  _VKJHetv2tThvbYgUfWntkIWWvKq_Mw6V6Bnx1GiysmA,
_LLBkxL_DVxr8MB7QJOIrh7wRxslYMSy3UexKfXRZuFI
];
...
const _B1EKvO = eventHandler((event) => {
...
const getServerEntry = () => import('file://C:/news-scraper/2026Study/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file://C:/news-scraper/2026Study/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_NNL6Cf = () => Promise.resolve().then(function () { return scrape_post$1; });
const _lazy_ObdlVO = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _B1EKvO, lazy: false, middleware: true, method: undefined },
  { route: '/api/scrape', handler: _lazy_NNL6Cf, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_ObdlVO, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ObdlVO, lazy: true, middleware: false, method: undefined }
];
...
const scrape_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: scrape_post
});
